...
timeout - anything at all. That's what makes this safe to ship before a real
...
def generate_escalated_hint(
    ...
    try:
        ...
        generated = generate_text(prompt, max_tokens=_MAX_TOKENS).strip()
